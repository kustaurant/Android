...
class TierListFragment : Fragment() {
    ...
    lateinit var tierRestaurantadapter: TierRestaurantAdapter
    ...
    override fun onCreateView(
        ...
        // 어댑터 초기화
        tierRestaurantadapter = TierRestaurantAdapter(tierRestaurantList)

        binding.recyclerviewTier.adapter = tierRestaurantadapter
